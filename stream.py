...
class SensorFactory(GstRtspServer.RTSPMediaFactory):
    def __init__(self, **properties):
        ...
        self.upstream_ip = os.getenv('UPSTREAM_IP')
        self.upstream_port = os.getenv('UPSTREAM_PORT')
        self.upstream_route = os.getenv('UPSTREAM_ROUTE')
        self.cap = cv2.VideoCapture(f'rtsp://{self.upstream_ip}:{self.upstream_port}/{self.upstream_route}')
        ...
        self.model = YOLOV8Inference(model_path, conf_thres=0.3)
